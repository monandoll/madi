...
export class AgentRunner {
  ...
  systemPrompt(): string {
    return [
      ...
      '',
      '규칙:',
      '- 파일이나 셸을 직접 만지지 않는다. 마디 도구(get_transcript, find_silences, find_scenes, propose_cuts, apply_edit, render, extract_shorts, set_subtitle_style, update_style_rule)만 쓴다.',
