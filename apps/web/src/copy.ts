...
export const copy = {
  ...
  settings: {
    ...
    aiRetry: '다시 찾기',
    aiRetrying: '다시 찾는 중',
    aiRetryHelp: '방금 깔았거나 껐다 켰으면 다시 찾기를 눌러 주세요.',
    aiPick: '직접 찾기',
    aiPicking: '창에서 고르는 중',
    aiPickHelp: '컴퓨터마다 깔리는 자리가 달라요. 못 찾으면 실행 파일을 직접 골라 주세요.',
    aiPickBad: '그 파일로는 안 되네요. 다른 걸 골라 주세요.',
    aiPickFailed: '파일 고르기 창을 열지 못했어요.',
    aiCustom: '직접 고른 파일로 연결돼 있어요',
    aiCustomClear: '직접 고른 것 지우기',
    aiInstall: '이 컴퓨터에 깔기',
    aiInstalling: '받는 중…',
    aiInstallChecking: '거의 다 됐어요…',
    aiInstallDone: '다 깔았어요. 이제 연결할 수 있어요.',
    aiInstallHelp: '마디가 알아서 받아서 깔아요. 3분쯤 걸리고, 다른 프로그램은 안 깔아요.',
    aiInstallFail: {
      network: '인터넷이 끊겨서 못 받았어요. 연결을 확인하고 다시 눌러 주세요.',
      permission: '이 컴퓨터가 설치를 막았어요. 아래 "터미널에서 직접 하기"로 해 주세요.',
      unsupported: '이 컴퓨터에서는 마디가 대신 깔 수 없어요. 아래 방법으로 해 주세요.',
      timeout: '너무 오래 걸려서 멈췄어요. 다시 눌러 주세요.',
      failed: '깔다가 잘 안 됐어요. 다시 눌러 보고, 그래도 안 되면 아래 방법으로 해 주세요.',
    } as Record<string, string>,
    aiInstallRetry: '다시 깔기',
    aiInstallClose: '닫기',
    aiLogin: '로그인 하기',
    aiLoginHelp: '여기서 바로 로그인해요. 폰으로 들어와 있어도 똑같이 돼요.',
    aiLoginFailed: '로그인 창을 열지 못했어요. 아래 방법으로 해 주세요.',
    aiManual: '터미널에서 직접 하기',
    aiManualHelp: '아래 줄을 복사해서 터미널(맥은 터미널, 윈도우는 PowerShell)에 붙여 넣고 엔터를 누르세요.',
    aiManualCopy: '복사',
    aiManualCopied: '복사했어요',
    termOpening: '창 여는 중',
    termClose: '닫기',
    termHelp: '아래 창에 나오는 안내를 따라가면 돼요. 주소가 보이면 눌러서 열고, 물어보면 여기에 입력하세요.',
    termDone: '다 됐어요. 창을 닫아도 돼요.',
    termStopped: '중간에 끝났어요. 다시 열어 보세요.',
    termBusy: '창이 이미 하나 열려 있어요. 그걸 먼저 닫아 주세요.',
    termMissing: '이 도구를 찾지 못해서 창을 열 수 없어요. 먼저 깔아 주세요.',
    termFailed: '창을 여는 데 실패했어요. 마디를 껐다 켜 보세요.',
    termLine: (line: string) => `터미널에서 직접 하려면: ${line}`,
  ...
  error: {
    ...
    ai_missing: 'AI 도구를 이 PC에서 찾지 못했어요. 설정 → AI 연결에서 다시 찾거나 깔 수 있어요.',
    ai_failed: 'AI가 답하다가 문제가 생겼어요. 한 번 더 말해 주세요.',
    ai_login: 'AI 도구에 로그인이 안 되어 있어요. 설정 → AI 연결에서 "로그인 창 열기"를 한 번 눌러 주세요.',
